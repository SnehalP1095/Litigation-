		...
		wait.until(ExpectedConditions.visibilityOf(performerPOM.GridLoad(driver)));	//Wait until records table gets visible.
          ...
          //--------------------------------Case----------------------------------
		      ...
		      Thread.sleep(4000);
		       ...
		       Thread.sleep(3000);
		       test.log(LogStatus.PASS, "Document  Vier Successfully.");
...
//		performerPOM.selectFromDate(driver).click();
	...
	static void NewReminder(WebDriver driver, ExtentTest test, String type) throws InterruptedException
	{
		...
		Thread.sleep(3000);
		performerPOM.clickReminderText(driver).sendKeys("Automation Testing reminder message6.");
		
		Thread.sleep(3000);
		performerPOM.clickDescription(driver).sendKeys("Automation reminder description23.");
		
		Thread.sleep(3000);
		performerPOM.clickRemark2(driver).sendKeys("Automation reminder remark3.");
...
//		CaseNoticeType(driver,test);
	...
	public static void LegalEntity(WebDriver driver,ExtentTest test) throws InterruptedException
	 {
  ...
  public static void LawFirm(WebDriver driver, ExtentTest test) throws InterruptedException
  {
	    Thread.sleep(3000);
	    performerPOM.clickMasters(driver).click();
	  //  Thread.sleep(3000);
 ...
 public static void User(WebDriver driver, ExtentTest test) throws InterruptedException
	{
	    Thread.sleep(1000);
	    performerPOM.clickMasters(driver).click();
//	    Thread.sleep(3000);
//		performerPOM.clickMastersMenu(driver).click();
  ...
  public static void Opponent(WebDriver driver, ExtentTest test) throws InterruptedException
  {
	    WebDriverWait wait=new WebDriverWait(driver, 30);
		 Thread.sleep(5000);
		 performerPOM.clickMasters(driver).click();
...
//	     performerPOM.clickMastersMenu(driver).click();
  ...
  public static void Court(WebDriver driver, ExtentTest test) throws InterruptedException
   {
	   WebDriverWait wait=new WebDriverWait(driver,30);
...
//		         driver.switchTo().alert().accept();		
   ...
   public static void CaseNoticeType(WebDriver driver, ExtentTest test) throws InterruptedException
   {
	    WebDriverWait wait=new WebDriverWait(driver,20);  
	    Thread.sleep(3000);
	    performerPOM.clickMasters(driver).click();
	...
	public static void PaymentType(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		 WebDriverWait wait=new WebDriverWait(driver,20);  
		  Thread.sleep(3000);
		  performerPOM.clickMasters(driver).click();
     ...
     public static void customParameter(WebDriver driver, ExtentTest test) throws InterruptedException
	  {
		 WebDriverWait wait=new WebDriverWait(driver,20);  
...
//	         driver.switchTo().alert().accept();		
     ...
     public static void CaseStage(WebDriver driver, ExtentTest test) throws InterruptedException
     {
    	 WebDriverWait wait=new WebDriverWait(driver,20);  
    	  Thread.sleep(3000);
		  performerPOM.clickMasters(driver).click();
...
//		  performerPOM.clickMastersMenu(driver).click();
	  ...
	  public static void DocumentType(WebDriver driver, ExtentTest test) throws InterruptedException
		  {
		      WebDriverWait wait=new WebDriverWait(driver,20);  
		      Thread.sleep(3000);
		      performerPOM.clickMasters(driver).click();
...
//		      performerPOM.clickMastersMenu(driver).click();
	  ...
	  public static void RatingCriteria(WebDriver driver, ExtentTest test) throws InterruptedException
	  {
		  WebDriverWait wait=new WebDriverWait(driver,20);  
		  Thread.sleep(3000);
		  performerPOM.clickMasters(driver).click();
...
//		  performerPOM.clickMastersMenu(driver).click();
	  ...
	  public static void PageAuthorization(WebDriver driver, ExtentTest test) throws InterruptedException
	  {
		  Thread.sleep(3000);
		  performerPOM.clickMasters(driver).click();
//		  Thread.sleep(3000);
//		  performerPOM.clickMastersMenu(driver).click();
	  ...
	  public static void NoticeStage(WebDriver driver, ExtentTest test) throws InterruptedException
	  {
...
//		  performerPOM.clickMastersMenu(driver).click();
	  ...
	  public static void UserReassignment(WebDriver driver, ExtentTest test) throws InterruptedException
	  {
